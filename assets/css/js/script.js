...
for (let i = 0; i < starWarsCharacters.length; i++) {
    ...
    switch (character.eye_color) {
        case 'blue':
            perColoriOcchi.blue.push(character);
            break;
        case 'yellow':
            perColoriOcchi.yellow.push(character);
            break;
        case 'brown':
            perColoriOcchi.brown.push(character);
            break;
        case 'red':
            perColoriOcchi.red.push(character);
            break;
        case 'blue-gray':
            perColoriOcchi['blue gray'].push(character);
            break;
    }
};

console.table(perColoriOcchi);
...
for (let i = 0; i < nomi.length; i++) {
    for (let c = 0; c < personaggiFemminili.length; c++) {
        if (nomi[i] === personaggiFemminili[c].name) {
            nomi.splice(i, 1);
            i--;
            break;
        }
